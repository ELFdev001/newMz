...
public abstract class BaggageAnimal extends MWGridAgent {


	public BaggageAnimal(final ClassType pClassType, final Location pLocation, final int pCampID, final int pObjectID) {
